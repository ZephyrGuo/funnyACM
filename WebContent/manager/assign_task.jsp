...
<body>
		 ...
		 <table class="__table">
			  <tr>
			      ...
			      <td width="80%"><input type="text" class="form-control" id="task_name" value=""></td>
			  </tr>
			  <tr>
			  	 <td><label>任务描述</label></td>
			  	 <td><textarea id="task_description" rows="5" value=""></textarea></td>
			  </tr>
			  <tr>
			      <td><label>开始日期</label></td>
			      <td><input type="text" class="form-control" id="start_time" value="">格式如：2015-04-07 18:05</td>
			  </tr>
			  <tr>
			  	 <td><label>任务模板 </label></td>
			  	 <td><button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#chooseTplModal">选择</button></td>
			  </tr>
			  <tr>
			  	 <td><label>队员 </label></td>
			  	 <td><button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#chooseUserModal">选择</button>
			  	 </td>
			  </tr>
		</table>
		...
		<div class="panel panel-default">
  			<div class="panel-heading">[已选队员]</div>
		...
		<div class="panel panel-default">
 			...
 			<table>
	 			...
	 			<tr><td>
					...
					<input type="number" class="form-control" id="condition_cnt" value="0">
				</td></tr>
		...
		<div align="center">
			<button type="button" class="btn btn-success" onclick="assignTask()">发布任务</button>
			<input type="hidden" id="task_tpl_id" value="">
		</div>
		
<!-- choose task template Modal -->
<div class="modal fade" id="chooseTplModal" role="dialog" aria-hidden="true">
