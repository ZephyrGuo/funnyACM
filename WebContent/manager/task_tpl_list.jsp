...
<body>
	...
	<%
		Task task = new LoadAllTaskTplTask(out);
		task.doRequest(request);
	%>
	
	<table class="table table-bordered">
  		<tr>
  			<td width="66%" align="center">任务模版</td>
...
<%
	...
	if(i>0) 
		page_btn_HTML+="<li><a href=\"./task_tpl_list.jsp?i="+(i-n)+"&n="+n+"\">上一页</a></li>";
	if(i+n<TaskTemplateORM.getInstance().getTaskTplCnt()) 
		page_btn_HTML+="<li><a href=\"./task_tpl_list.jsp?i="+(i+n)+"&n="+n+"\">下一页</a></li>";
